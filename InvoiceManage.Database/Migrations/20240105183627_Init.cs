        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Indatim = table.Column<decimal>(type: "TEXT", nullable: true),
                    Indatim_1 = table.Column<string>(type: "TEXT", nullable: true),
                    Indatim_2 = table.Column<string>(type: "TEXT", nullable: true),
                    Indatim2m = table.Column<decimal>(type: "TEXT", nullable: true),
                    ...
                    Cdcd = table.Column<decimal>(type: "TEXT", nullable: true),
                    Cap = table.Column<decimal>(type: "TEXT", nullable: true),
                    Insp = table.Column<decimal>(type: "TEXT", nullable: true),
                    Tax17 = table.Column<decimal>(type: "TEXT", nullable: true),
                    ...
                    Pdt = table.Column<decimal>(type: "TEXT", nullable: true),
                    Pdt_2 = table.Column<string>(type: "TEXT", nullable: true),
                    Pv = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mu = table.Column<int>(type: "INTEGER", nullable: true),
