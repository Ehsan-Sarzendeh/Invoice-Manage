        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Inno_1 = table.Column<decimal>(type: "TEXT", nullable: false),
                    ...
                    BillId = table.Column<string>(type: "TEXT", nullable: true),
                    Tprdis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tdis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tadis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tvam = table.Column<decimal>(type: "TEXT", nullable: false),
                    Todam = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tbill = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tonw = table.Column<decimal>(type: "TEXT", nullable: false),
                    Torv = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tocv = table.Column<decimal>(type: "TEXT", nullable: false),
                    Cap = table.Column<decimal>(type: "TEXT", nullable: false),
                    Insp = table.Column<decimal>(type: "TEXT", nullable: false),
                    Tvop = table.Column<decimal>(type: "TEXT", nullable: false),
                    ...
                    Inty_1 = table.Column<string>(type: "TEXT", nullable: true),
                    Inp = table.Column<int>(type: "INTEGER", nullable: false),
                    Ins = table.Column<int>(type: "INTEGER", nullable: false),
                    Tob = table.Column<int>(type: "INTEGER", nullable: false),
                    Ft = table.Column<int>(type: "INTEGER", nullable: false),
                    Pmt = table.Column<int>(type: "INTEGER", nullable: false),
                    Setm = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tsstam = table.Column<decimal>(type: "TEXT", nullable: false),
                    ...
                    Prdis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Dis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Adis = table.Column<decimal>(type: "TEXT", nullable: false),
                    Vra = table.Column<double>(type: "REAL", nullable: false),
                    Vam = table.Column<decimal>(type: "TEXT", nullable: false),
                    ...
                    Tcpbs = table.Column<decimal>(type: "TEXT", nullable: false),
