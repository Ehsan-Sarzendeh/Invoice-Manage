...
namespace InvoiceManage.App.Forms
{
    public partial class Total : Form
    {
        ...
        private void tabPage_Seller_Click(object sender, EventArgs e)
        {

        }

        private void tabPage_SumofInvoice_Click(object sender, EventArgs e)
        {

        }

        private void comboBox_setm_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void tabControl_Invoice_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void tabPage_Buyer_Click(object sender, EventArgs e)
        {
        ...
        private void maskedTextBox_indatim_2_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void maskedTextBox_indatim_1_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void maskedTextBox_cdcd_1_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void tabpage_InvoiceType_Click(object sender, EventArgs e)
        {
        ...
        private void comboBox_ft_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void tabPage_Invoicedetail_Click(object sender, EventArgs e)
        {
        ...
        private void tabPage_Payment_Click(object sender, EventArgs e)
        {

        }

        private void comboBox_pmt_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void maskedTextBox_pdt_2_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {

        }

        private void maskedTextBox_pdt_1_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void tabPage_SendInvoiceto_Click(object sender, EventArgs e)
        {
